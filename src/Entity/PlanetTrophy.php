...
use App\Repository\PlanetTrophyRepository;
use Doctrine\ORM\Mapping as ORM;

#[ORM\Entity(repositoryClass: PlanetTrophyRepository::class)]
class PlanetTrophy
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\ManyToOne(targetEntity: Planet::class, inversedBy: 'trophies')]
    #[ORM\JoinColumn(nullable: false)]
    private ?Planet $planet = null;

    #[ORM\ManyToOne(targetEntity: Trophy::class, inversedBy: 'planetTrophies')]
    #[ORM\JoinColumn(nullable: false)]
    private ?Trophy $trophy = null;

    #[ORM\ManyToOne(targetEntity: Season::class, inversedBy: 'planetTrophies')]
